...
export default function NotFoundPage() {
  return <Wrap><div><Clapperboard size={34} /><div className="code">404</div><h1>This scene does not exist</h1><p>The address may have changed, or this movie is no longer playing here.</p><Button as={Link} to="/"><Home size={17} /> Back to home</Button></div></Wrap>;
}
